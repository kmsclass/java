 ...
 *   hashcode : 원래의미는 JVM이 객체를 구별하기위한 고유의값(참조값)
 *          물리적동등성 : 실제 같은 객체인 경우
 *          논리적동등성 : 내용 기준으로 같은 객체로 판단하는 경우 
 *          논리적 동등성을 위해 오버라이딩이 필요함.
 *          
 * 두객체가 논리적을 동등하다는 판단 기준         
...
public class ObjectEx3 {
	public static void main(String[] args) {
		...
		if(s1.equals(s2)) System.out.println("s1과 s2는 같은내용의 객체임");
		else System.out.println("s1과 s2는 다른내용의 객체임");
		//String 클래스에서 오버라이딩됨
		System.out.println("s1.hashCode():" + s1.hashCode());
		System.out.println("s2.hashCode():" + s2.hashCode());
		System.out.println("s1 의 고유의 hashcode:" + 
		                            System.identityHashCode(s1));
		System.out.println("s2 의 고유의 hashcode:" + 
                                    System.identityHashCode(s2));
		Equal e1 = new Equal(10);
		Equal e2 = new Equal(10);
		System.out.println("e1.hashCode():" + e1.hashCode());
		System.out.println("e2.hashCode():" + e2.hashCode());
		System.out.println("e1 의 고유의 hashcode:" + 
                                 System.identityHashCode(e1));
		System.out.println("e2 의 고유의 hashcode:" + 
