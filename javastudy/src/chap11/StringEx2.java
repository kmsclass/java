...
public class StringEx2 {
	public static void main(String[] args) {
		...
		/*
		 * s.compareTo("abc") : 결과가 양수  s 문자열이 "abc" 문자열보다 뒤쪽
		...
		//s.startsWith('AB') : s 문자열이 AB로 시작하는지 여부.
