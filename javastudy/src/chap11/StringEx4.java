package chap11;
/*
 * String.format 메서드 : 형식화된문자열 리턴. 서식문자 사용. 클래스메서드=> 객체화 필요없음.
 * 서식문자 : %d,%s,%f,%c ....
 * 
...
public class StringEx4 {
	public static void main(String[] args) {
		...
		System.out.println(sf);
		//%,10d : 10진 정수 출력. 10자리 확보,우측정렬,세자리 ,출력
		sf = String.format("%,10d", 12345);
		System.out.println(sf);
		//%-,10d : 10진 정수 출력. 10자리 확보,좌측정렬,세자리 ,출력
		sf = String.format("%-,10d", 12345);
		System.out.println(sf);
		...
		System.out.println(sf);
		//10자리 확보하고 우측정렬하여 출력하기
		sf = String.format("%10s", "홍길동");
		System.out.println(sf);
		//10자리 확보하고 좌측정렬하여 출력하기
		sf = String.format("%-10s", "홍길동");
		System.out.println(sf);
		//%c : 문자한개 출력
