...
//		SortedSet<String> set = new TreeSet<>();
		...
		System.out.println("역순으로 정렬방식으로 set 객체 생성하기");
		//Comparator.reverseOrder() : 기본정렬방식의 역순
		set2 = new TreeSet<>(Comparator.reverseOrder()); //내림차순정렬
		...
		set3.add("elev");set3.add("fan");set2.add("flower");
