 ...
 *   멤버메서드
 *      void buy(Food)
 *        1. 현재잔액보다 물품값이 큰경우 잔액부족 메세지 출력하고 메서드 종료
 *        2. 보유금액에서 물품가격만큼 차감
 *        3. 물품의 포인트만큼 포인트 증가
 *        4. 물품명과 가격을 출력
 *        5. 장바구니에 구매물품추가. cnt 1 증가.    
 *      void summary()
 *        1. cart 상품을 조회하여 구매한 물품의 목록 출력
 *        2. cart 상품을 조회하여 구매한 물품의 가격,포인트 합계 출력
 *        3. 구매한 상품 중 과일의 갯수,과일구매금액,과일구매 목록 출력하기
 *        4. 구매한 상품 중 음료의 갯수,음료구매금액,음료구매 목록 출력하기
 *        5. 구매한 상품 중 과자의 갯수,과자구매금액,과자구매 목록 출력하기
 *        6. 현재 잔액과 포인트 출력하기
 */
class Buyer {
	int money=10000;
	...
	void summary() {
		...
		System.out.println
		("과일구매갯수:"+fcnt+",과일구매금액:"+fprice + ",과일구매목록:"+flist);
		System.out.println
		("음료구매갯수:"+dcnt+",음료구매금액:"+dprice + ",음료구매목록:"+dlist);
		System.out.println
		("과자구매갯수:"+scnt+",과자구매금액:"+sprice + ",과자구매목록:"+slist);
		//6. 현재 잔액과 포인트 출력하기
